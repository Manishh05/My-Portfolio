        ...
        <div  className=''>
          ...
          <div className='About-details d-flex'>
           <div className='img-box'>
            ...
            <div className='d-flex justify-content-center py-5 gap-10 about-content'>
             <h6>I am a Passionate and creative
               <span className='text-warning'> Front-End-Developer</span> with a Strong intrest in Web Development and User interface design.
